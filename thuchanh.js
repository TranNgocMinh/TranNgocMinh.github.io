...
$(document).ready(function () {
    ...
    var question1 = {
        ...
        answers: ["Nền hồng, tiêu đề xanh dương, văn bản cỡ chữ to, đậm", "Nền hồng, tiêu đề xanh, văn bản cỡ chữ to, đậm và màu nền vàng", "Nền hồng, tiêu đề xanh dương và canh giữa, văn bản phông chữ thay đổi và màu nền vàng", "Nền hồng, tiêu đề xanh dương và canh giữa, văn bản cỡ chữ to, đậm và màu nền vàng"],
        correct: 3
    };

    var question2 = {
        question: "Bước 2: Xác định các selector (bộ chọn)",
        answers: ['p, p, h1, body', 'p, p, h1', 'body, h1, p, html', 'body, h1, p'],
        correct: 3
    };

    var question3 = {
        question: 'Bước 3: Khai báo CSS',
        answers: ['body{background-color:pink;} h1{color:blue;} p{font-size:20px; font-weight:bold}', 'body{background-color:pink;} h1{color:blue;} p{font-size:20px; font-weight:bold; background-color:yellow;}', 'body{background-color:pink;} h1{color:blue; text-aligh:center;} p{font-family:verdana; background-color:yellow;}', 'body{background-color:pink;} h1{color:blue; text-align:center;} p{font-size:20px; font-weight:bold; background-color:yellow;}'],
        correct: 3
    }
