...
$(document).ready(function () {
    ...
    //*****************************************************************************
    var question1 = {
        question: "Bước 1: Xác định yêu cầu",
        answers: ["Nền xanh dương nhạt, tiêu đề trắng, canh giữa, văn bản cỡ chữ to, phông chữ thay đổi", "Nền xanh dương nhạt, tiêu đề trắng, canh giữa, văn bản cỡ chữ to, đậm", "Nền xanh dương nhạt, tiêu đề trắng, canh giữa", "Tất cả lựa chọn trên đều đúng"],
        correct: 0
    };

    var question2 = {
        question: "Bước 2: Xác định các selector (bộ chọn)",
        answers: ['p, h1, body', 'p, h1', 'body, h1, p, html', 'body, p'],
        correct: 0
    };

    var question3 = {
        question: 'Bước 3: Khai báo CSS',
        answers: ['body{background-color:lightblue;} h1{color:yellow;text-align:center;} p{font-size:20px; font-weight:bold}', 'body{background-color:lightblue;} h1{color:white;} p{text-align:center;font-size:20px; font-weight:bold}', 'body{background-color:lightblue;} h1{color:white;} p{font-size:20px; font-family:verdana;}', 'body{background-color:lightblue;} h1{color:white;text-align:center;} p{font-size:20px; font-family:verdana;}'],
        correct: 3
    }
    ...
    function showResults() {
        ...
        if (correctAns == 3) {
            ...
            newCongrats.id = "red";
            var textCongrats = document.createTextNode('Chúc mừng bạn đã hoàn thành 3 bước đầu tiên. Vui lòng nhấn vào dòng liên kết để chuyển sang bước cuối cùng. ');
            newCongrats.appendChild(textCongrats);
            var a = document.createElement('a');
            var linkText = document.createTextNode("Bước 4: Kiểm tra");
            a.appendChild(linkText);
            a.title = "Bước 4: Kiểm tra";
            a.href = "baitap02.html";
            ...
            var newCongrats = document.createElement('p');
            newCongrats.id = "red";
            var textCongrats = document.createTextNode('Bạn chưa hoàn thành các bước. Nhấn F5 thực hiện lại')
            newCongrats.appendChild(textCongrats);
            document.getElementById('display-area').appendChild(newCongrats);
